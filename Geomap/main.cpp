...
{
	if (angleOfLine(gs) <= 22.5)
		return "east";
	else if (angleOfLine(gs) <= 67.5)
		return "northeast";
	else if (angleOfLine(gs) <= 112.5)
		return "north";
	else if (angleOfLine(gs) <= 157.5)
		return "northwest";
	else if (angleOfLine(gs) <= 202.5)
		return "west";
	else if (angleOfLine(gs) <= 247.5)
		return "southwest";
	else if (angleOfLine(gs) <= 292.5)
		return "south";
	else if (angleOfLine(gs) <= 337.5)
		return "southeast";
	else
		return "east";
}
